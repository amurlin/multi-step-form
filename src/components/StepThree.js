  ...
  return (
    ...
    <div className='w-[480px] h-[655px] p-[32px] bg-white flex flex-col justify-between rounded-[8px]'>
      ...
      <div className='mt-[28px] flex flex-col gap-[12px] '>
        ...
        <InputSection handleChange={handleChange} errors={errors} question={"Date of Birth"} name={"dateBirth"} placeholder={""} />
        <InputSection handleChange={handleChange} errors={errors} question={"Profile image"} name={"profileImg"} placeholder={""} />
